    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li class=""><a href="{{ url('category/其它') }}">其它</a></li>
            </ul>
            ...
            <ul class="nav navbar-nav navbar-right log-reg">
                ...
                @if (!auth('admin')->user()->name)
                    <li><a href="{{ url('/login') }}">登录</a></li>
                    <li><a href="{{ url('/register') }}">注册</a></li>
                @else
                    <a href="#">
                        <img src="{{ asset('static/images/avatar/'.auth('admin')->user()->thumb.'.png') }}" id="thumb">
                        <span class="sr-only" id="userThumb">{{ auth('admin')->user()->thumb }}</span>
                    </a>
                    <li class="dropdown">
...
<div class="container-fluid" style="margin-top:1%;">
    <div class="row">
        <div class="col-md-10 text-center copy-text">
            ...
            {{-- 微信 --}}
            <a href="https://mp.qq.weixin.com" target="_blank" id="WeChat"
               data-toggle="tooltip" data-placement="top" title="shorylee's WeChat">
